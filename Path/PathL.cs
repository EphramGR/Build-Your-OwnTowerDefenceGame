...
public class PathL : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rotate = 0;
        locked = false;
        closeobj = GameObject.Find("PathL");
        collnumb = 0;
    ...
    void Update()
    {
        if(!placed && gameObject.name.Contains("(Clone)"))
        {
            ...
            if(!baseadj)
            {
                ...
                {
                    if(rotate % 4 == 0 && (baseRotate % 4 == 1 | baseRotate % 4 == 2)) //sw down left
                    {
                    ...
                    else if(rotate % 4 == 1 && (baseRotate % 4 == 2 | baseRotate % 4 == 3)) //se down right
                    {
                        cs.adj = true;
                        if(baseRotate % 4 == 0)
                        {
                    ...
                    else if(rotate % 4 == 2 && (baseRotate % 4 == 0 | baseRotate % 4 == 3)) //ne up right
                    {
                        cs.adj = true;
                        if(baseRotate % 4 == 0)
                        {
                    ...
                    else if(rotate % 4 == 3 && (baseRotate % 4 == 1 | baseRotate % 4 == 0)) //nw up left
                    {
                        cs.adj = true;
                        if(baseRotate % 4 == 0)
                        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (Input.GetMouseButtonDown(0))
                    {
                        ...
                        foreach (var obj in objects) 
                        {
                            if (gameObject.transform.position.x == obj.transform.position.x && gameObject.transform.position.y == obj.transform.position.y && gameObject != obj)
                            {
                                test = false;
                            }
                        }
                        if (test)
                        {
                            ...
                            {
                                //
                                if(rotate % 4 == 0 && (side % 4 == 1 | side % 4 == 2) && collnumb == 0)
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if(rotate % 4 == 1 && (side % 4 == 2 | side % 4 == 3) && collnumb == 0)
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if(rotate % 4 == 2 && (side % 4 == 3 | side % 4 == 0) && collnumb == 0)
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if(rotate % 4 == 3 && (side % 4 == 1 | side % 4 == 0) && collnumb == 0)
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                            ...
                            else if (closeobj.name.Contains("PathT"))
                            {
                                ...
                                //
                                if (side % 4 == 0 && closerotate % 4 != 1 && (rotate % 4 == 2 | rotate % 4 == 3) && collnumb == 0)//down, and other not hole down
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 1 && closerotate % 4 != 2 && (rotate % 4 == 0 | rotate % 4 == 3) && collnumb == 0)//right, and other not right
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 2 && closerotate % 4 != 3 && (rotate % 4 == 0 | rotate % 4 == 1) && collnumb == 0)//up, and other not hole up
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 3 && closerotate % 4 != 0 && (rotate % 4 == 2 | rotate % 4 == 1) && collnumb == 0)//left, and other not left
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                            ...
                            else if (closeobj.name.Contains("PathL"))
                            {
                                ...
                                if (side % 4 == 0 && (closerotate % 4 == 0 | closerotate % 4 == 1) && (rotate % 4 == 2 | rotate % 4 == 3) && collnumb == 0)//down
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 1 && (closerotate % 4 == 2 | closerotate % 4 == 1) && (rotate % 4 == 0 | rotate % 4 == 3) && collnumb == 0)//right
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 2 && (closerotate % 4 == 3 | closerotate % 4 == 2) && (rotate % 4 == 1 | rotate % 4 == 0) && collnumb == 0)//up
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                                else if (side % 4 == 3 && (closerotate % 4 == 0 | closerotate % 4 == 3) && (rotate % 4 == 2 | rotate % 4 == 1) && collnumb == 0)//left
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
                            ...
                            else
                            {
                                ...
                                //
                                if (closerotate && ((side % 4 == 1 && (rotate % 4 == 0 | rotate % 4 == 3)) | (side % 4 == 3 && (rotate % 4 == 2 | rotate % 4 == 1))) && collnumb == 0)
                                { 
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0); 
                                    placing();
                                }
                                else if (!closerotate && ((side % 4 == 0 && (rotate % 4 == 3 | rotate % 4 == 2)) | (side % 4 == 2 && (rotate % 4 == 1 | rotate % 4 == 0))) && collnumb == 0)
                                {
                                    transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                    placing();
                                }
