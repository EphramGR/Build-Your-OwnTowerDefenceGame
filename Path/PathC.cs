...
public class PathC : MonoBehaviour
{
    private bool placed;
    private bool locked;
    private int side;
    ...
    void Start()
    {
        placed = false;
        locked = false;
        closeobj = GameObject.Find("PathC");
        collnumb = 0;
                ...
                else
                {
                    ...
                    if (Input.GetMouseButtonDown(0))
                    {
                        ...
                        else if (closeobj.name.Contains("PathL"))
                        {
                            ...
                            if(closerotate % 4 == 0 && (side % 4 == 0 | side % 4 == 3) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                placing();
                            }
                            else if(closerotate % 4 == 1 && (side % 4 == 0 | side % 4 == 1) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                placing();
                            }
                            else if(closerotate % 4 == 2 && (side % 4 == 2 | side % 4 == 1) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                placing();
                            }
                            else if(closerotate % 4 == 3 && (side % 4 == 2 | side % 4 == 3) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                placing();
                            }
                        ...
                        else
                        {
                            ...
                            //
                            if (closerotate && (side % 4 == 1 | side % 4 == 3) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0); 
                                placing();
                            }
                            else if (!closerotate && (side % 4 == 0 | side % 4 == 2) && collnumb == 0)
                            {
                                transform.position = new Vector3(transform.position.x, transform.position.y, 0);
                                placing();
                            }
